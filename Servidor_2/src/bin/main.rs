...
fn main() {
  ...
  let state_trash = State{ players: vec![], map: vec![], canvas_height: 0, canvas_width: 0, match_time:0, game_is_over:false };

  let current_state = Arc::new(Mutex::new(state_trash));
